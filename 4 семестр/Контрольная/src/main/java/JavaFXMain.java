...
public class JavaFXMain extends javafx.application.Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        // Основная сцена
        primaryStage.setTitle("База данных поликлиники");
        ...
        labelsBox.getChildren().addAll(col1, col2, col3, col4);
        ...
        MenuButton selector = new MenuButton("Возраст");
        ...
        MenuItem yearSelect = new MenuItem("Возраст");
        yearSelect.setOnAction(e -> {
            selector.setText("Возраст");
...
//        System.out.println(selector.getItems());
        ...
        tab1.setContent(mainBox);
        Tab tab2 = new Tab();
        tab2.setText("Procedure");

        VBox secondBox = JavaFXadditionals.create2ndBox();
        tab2.setContent(secondBox);
...
//        mainBox.getChildren().add(but);
    ...
    public static void createTable(Boolean changePie) {
        ...
        var allPatList = Main.getPatList(propName, order);
    ...
    static void fillData(List<PatientEntity> allServicingList) {
...
//        costMap.put("> 10000", 0);
        ...
        for (var service : allServicingList) {
            String year = String.valueOf(service.getAge());
